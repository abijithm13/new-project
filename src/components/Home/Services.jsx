    ...
    return(
        <div className="py-[100px] px-15">
            <div className="max-w-[1240px] mx-auto md:grid grid-cols-4 gap-5">
                <div className="shadow-xl  h-[400px] my-5 hover:scale-110 bg-black text-white  hover:text-red-600 duration-200 rounded-lg">
                ...
                <h2 className='text-2xl font-bold text-center py-8'>Technology Consulting</h2>
                <div className='text-center font-medium'>
                        <p className='py-2 mx-8 mt-8'> 
                ...
                <h2 className='text-2xl font-bold text-center py-8'>Business Analytics</h2>
                <div className='text-center font-medium'>
                        <p className='py-2 mx-8 mt-8'> 
